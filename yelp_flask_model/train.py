...
# Device mps not implemented for embeddedBag
...
if __name__ == "__main__":
    ...
    train_dataset, valid_dataset = torch.utils.data.random_split(train_val_dataset, lengths=[int(0.95*train_val_len), int(0.05*train_val_len)], generator=generator)
