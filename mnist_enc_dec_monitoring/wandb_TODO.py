...
class WandbLogger(Logger):
    ...
    def __init__(
        ...
        wandb.watch(models=model) #, log=UtLiteral["gradients", "weights"])
    ...
    def log_reconstruction_training(
        ...
        wandb.log(data={"train_loss_avg": train_loss_avg}, step=epoch)

        # TODO: Log validation reconstruction loss to wandb
        wandb.log(data={"val_loss_avg": val_loss_avg}, step=epoch)

        # TODO: Log a batch of reconstructed images from the validation set
        wandb.log(data={"reconstruction_grid": reconstruction_grid}, step=epoch)
    ...
    def log_embeddings(
        ...
        wandb.log(data={"embeddings": embeddings})
